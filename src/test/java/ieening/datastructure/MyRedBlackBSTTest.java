...
import com.ieening.datastructure.MyRedBlackBST;
...
public class MyRedBlackBSTTest {
    ...
    public void setUpEach() {
        myBinarySearchTree = new MyRedBlackBST<Integer, Integer>() {
        };
    }
    ...
    public void testComparisonAndHashing(String parameterJsonString) {
        MyBinarySearchTree<Integer, Integer> equalBST = new MyRedBlackBST<Integer, Integer>();
    ...
    public void testDraw(String parameterJsonString) {
        MyRedBlackBST<Character, Integer> bst = new MyRedBlackBST<>();
        ...
        bst.draw("src\\test\\java\\ieening\\output\\red_black_bst_" + jObject.getString("file") + ".png");
    }
}
